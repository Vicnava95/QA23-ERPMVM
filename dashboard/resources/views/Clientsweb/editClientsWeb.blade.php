            ...
            <div class=""></div>
                ...
                <div class="row">
                    <div id="form1" class="card-body">
                        ...
                        <form action="{{ route ('clientwebUpdate',$client) }}" name="form1" method="POST" class="well form-horizontal" enctype="multipart/form-data" >
                            @csrf @method('PATCH')
                            <fieldset>
                                <div class="row"> 
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="nameClient" name="nameClient" value="{{old('nameClient',$client->nameClient)}}" autocomplete="off" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control form-control-sm" id="emailClient" name="emailClient" value="{{old('emailClient',$client->emailClient)}}" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="locationField" >
                                                <input type="text" class="form-control form-control-sm" id="autocomplete" onFocus="geolocate()" name="addressClient" value="{{old('addressClient',$client->addressClient)}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="phoneClient" name="phoneClient" value="{{old('phoneClient',$client->phoneClient)}}" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
