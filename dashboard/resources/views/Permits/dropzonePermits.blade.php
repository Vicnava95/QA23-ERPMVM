...
{{--    {{HTML::style('css/bootstrap.css')}}--}}
    ...
    {{HTML::script('js/permit/dropzonePermit.js')}}
...
@section('content')
    <div class="container" style="margin-top: 20px;">
        <div class="row">
            <div class="col">
                <a href="{{route('infoPermit',$permitTicket->id)}}"><div class="btn btn-outline-secondary btn-sm" >Go Back</div></a>
            </div>
            <div class="col">
            ...
            <div class=""></div>
                ...
                <div class="row">
                    <div id="form1" class="card-body">
                        ...
                        <form action="{{route('dropzonePermitStore', $permitTicket)}}" class="dropzone" id="dropzone" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="fallback">
                        ...
                        <div class="text-center">
                            <a href="{{route('infoPermit',$permitTicket->id)}}"><div class="btn btn-secondary btn-sm drop" >Save Changes</div></a>
                        </div>
                    </div>
                </div>
            </div><!-- End Col 4 -->
