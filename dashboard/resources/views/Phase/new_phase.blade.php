            ...
            <div class="card bg-light col" style="margin: 10px;">
                <div class="row">
                    <div id="form1" class="card-body">
                        <h5 class="card-title text-center">Add Phase</h5>
                        <form action="{{ route ('phase.store',$project) }}" name="form1" method="POST" class="well form-horizontal" onsubmit="sub_butt.disabled = true; return true;" enctype="multipart/form-data" >
                            @csrf
                            <fieldset>
                            <div class="form-group">
                                <label style="font-size: 12px;">Project Name*</label>
                                <input type="text" class="form-control form-control-sm" value="{{$project->name_project}}" id="nameProject" name="nameProject" readonly>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm"  id="phaseNameProject" maxlength="100" name="phaseNameProject[]" placeholder="" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-group">
                                            <label style="font-size: 12px;">Budget</label>
                                            <input type="number" min="0" step="0.01" class="form-control form-control-sm" id="phaseBudgetProject" name="phaseBudgetProject[]" placeholder="" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="text-center">
                                <button type="submit" id="sub_butt" class="btn btn-secondary btn-sm">Submit Phase</button>
                            </div>
                            </fieldset>
                        </form>
                    </div>
