                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" value="{{$phase->name_phase}}" id="phaseNameProject" name="phaseNameProject[]" placeholder="" readonly>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-group">
                                            <label style="font-size: 12px;">Budget</label>
                                            <input type="number" class="form-control form-control-sm" value="{{$phase->budget_phase}}" id="phaseBudgetProject" name="phaseBudgetProject[]" placeholder="" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
