    ...
    <table id="mytableID" style="width:100%"  class="table table-striped sampleTable desktop"> 
        <thead>
            <tr>
                ...
                <th style="text-align:center;" data-sortas="case-insensitive">ERP Status</th>
        ...
        <tbody>
            @foreach ($allDailyReports as $dailyReport)
                <tr> 
                    ...
                    <td style="text-align:center;">{{$dailyReport->erpStatus}}</td>
    ...
    @foreach ($allDailyReports as $dailyReport)
        <div class="modal fade" id="exampleModal{{$dailyReport->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">{{$dailyReport->dateDailyReport}} - {{$dailyReport->project->name_project}}</h5>
                ...
                <div class="modal-footer">
                    ...
                    @if ($dailyReport->erpStatus == 'pending')
