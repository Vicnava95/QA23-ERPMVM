...
{{--       <h3 class="text-center">Total Payroll</h3>
      <h3 class="text-center">$254654</h3>
      <div class="container-fluid-a" style="overflow-x:auto;">
        <table class="table table-striped" border="1">
            <thead>
                <tr>
                    <th class="text-center"  style="border-color: black;">Weeks</th>
                    <th class="text-center"  style="border-color: black;">Project ID</th>
                    <th class="text-center"  style="border-color: black;">Labor</th>
                    <th class="text-center"  style="border-color: black;">Total</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($fechasXsemana as $fechas)
                    <tr>
                        <td style="border-color: black; vertical-align:middle"  width="450" align="center" rowspan="3">
                            @switch($fechas['week'])
                            @case($fechas['inicio'])
                                @if ($fechas['startDateQuery'] == $fechas['week_end'])
                                    <strong>{{$fechas['startDateQuery']}}</strong>
                        ...
                        <td style="border-color: black;" width="450">pop</td>
                        <td style="border-color: black;" width="450">12354</td>
                        <td style="border-color: black; vertical-align:middle" width="450"align="center" rowspan="3">
                            @foreach ($totales as $t)
                                @if($t['weekStart'] ==$fechas['week_start'])
                                    <div class="row-sm">
                    ...
                    <tr>
                        <td style="border-color: black;" width="450"></td>
                        <td style="border-color: black;" width="450"></td>
                    </tr>
                    <tr>
                        <td style="border-color: black;" width="450"></td>
