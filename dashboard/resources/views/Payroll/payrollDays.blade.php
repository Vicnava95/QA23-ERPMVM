...
@section('content')
    <div class="container-fluid" style="margin-top: 20px;">
        <div class="row">
            ...
            <div class="col text-center">
                <h4><a href="{{route('reportsDays',[$sDate,$eDate,4])}}" class="badge badgeERPButton" data-toggle="tooltip" data-placement="bottom" title="Go To Report"><i class="uil uil-file-bookmark-alt"></i></a></h4>
            </div>
            <div class="col text-center">
