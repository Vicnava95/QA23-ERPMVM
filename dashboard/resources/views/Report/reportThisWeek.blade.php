...
{{--         <div class="card-body">
            ...
            {{-- <h3 class="text-center"> <a href="#" onclick="location.href='/payrollThisWeek/'+startDate+'/'+endDate+'/'+2;return false;">Total Payroll</a></h3> --}}
            {{-- <length class="text-center" id="titulosResponsive"> <a href="#" onclick="location.href='/dashboard/public/payrollThisWeek/'+startDate+'/'+endDate+'/'+2;return false;">Total Payroll</a></length> --}}
            <length class="text-center" id="titulosResponsive"> <a href="#" onclick="location.href='/payrollThisWeek/'+startDate+'/'+endDate+'/'+2;return false;">Total Payroll</a></length>
