      ...
      <!-- START - Secciones por fecha -->
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs" id="hideNav">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="true" href="#" ><b>Last Week</b></a>
            </li>
            <li class="nav-item">
...
{{--         <div class="card-body">
            ...
            {{-- <h3 class="text-center"> <a href="#" onclick="location.href='/payrollLastWeek/'+lastWeekStart+'/'+lastWeekEnd+'/'+3;return false;">Total Payroll</a></h3> --}}
            {{-- <length class="text-center" id="titulosResponsive"> <a href="#" onclick="location.href='/dashboard/public/payrollLastWeek/'+lastWeekStart+'/'+lastWeekEnd+'/'+3;return false;">Total Payroll</a> </length> --}}
            <length class="text-center" id="titulosResponsive"> <a href="#" onclick="location.href='/payrollLastWeek/'+lastWeekStart+'/'+lastWeekEnd+'/'+3;return false;">Total Payroll</a> </length>
            <length class="text-center" id="titulosResponsive">${{$totalPayroll}}</length>
            @if ($totalPayroll != 0)
                ...
                <tbody>
                  @foreach ($diasX as $dias )
                      <tr>
                        ...
                        <td style="border-color: black; vertical-align:middle" width="450" align="center">
                          @foreach ($totalesXDia as $tdias)
                            @if($dias['days'] == $tdias['date'])
                              <strong>Total:</strong> <em>${{number_format($tdias['totalxDia'],2)}}</em>
                            @endif
                          @endforeach 
                        </td>
                        <td style="border-color: black;" width="450">
                          @foreach ($arrayProjectsXDay as $aProjectsXDay)
                            @if ($dias['days'] == $aProjectsXDay['day'])
            ...
            @if ($totalesProjects[0]['totalProfit'] != 0)
            <div class="container-fluid-a" style="overflow-x:auto;">
              <table class="table table-striped" border="1">
                <tbody>
                  ...
                  <tr>
                      ...
                      <td style="border-color: black;" width="450">
                        <strong>Expenses Until {{$endDate}}:</strong> <em>${{number_format($aProfit['expenses'],2)}}</em> 
                      </td>
                      <td style="border-color: black;" width="450">
