...
<div class="container-fluid" > 
  <figure class="text-center">
      <blockquote class="blockquote">
          <length id="showDate" data-bs-toggle="tooltip" data-bs-placement="top" title="Select Dates">Report of {{$startDate}} - {{$endDate}}</length>
      </blockquote>
  </figure>
  <figure class="text-center">
    <div class="dropdown" id="hideDropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="#" onclick="location.href='/reportsThisWeek/'+startDate+'/'+endDate+'/'+2;return false;">This Week</a>
...
{{--     <div class="card-body">
      ...
      <br>
        ...
        {{-- <h3 class="text-center"><a href="" onclick="location.href='/payrollThisMonth/'+startMonth+'/'+endtMonth+'/'+6;return false;">Total Payroll</a></h3> --}}
        {{-- <length class="text-center" id="titulosResponsive"><a href="" onclick="location.href='/dashboard/public/payrollThisMonth/'+startMonth+'/'+endtMonth+'/'+6;return false;">Total Payroll</a></length> --}}
        <length class="text-center" id="titulosResponsive"><a href="" onclick="location.href='/payrollThisMonth/'+startMonth+'/'+endtMonth+'/'+6;return false;">Total Payroll</a></length>
            ...
            <tbody>
              ...
              <tr>
                <td style="border-color: black; vertical-align:middle"  width="450" align="center" >
                  {{-- @if ($fechaXsemana['week'] == $fechaXsemana['inicio'])
                    @if ($fechaXsemana['startDateQuery'] == $fechaXsemana['week_end'])
                      <strong>{{$fechaXsemana['startDateQuery']}}</strong>
                    @else
                      <strong>{{$fechaXsemana['startDateQuery']}} - {{$fechaXsemana['week_end']}}</strong>
                    @endif
                    @else
                      @if ($fechaXsemana['week'] == $fechaXsemana['final'])
                        @if ($fechaXsemana['week_start'] == $fechaXsemana['endDateQuery'])
                          <strong>{{$fechaXsemana['endDateQuery']}}</strong>
                        @else
                ...
                <td style="border-color: black; vertical-align:middle"  width="450" >
                  @foreach ($totalXProjectSemana as $tXProjectSemana)
                    @if ($tXProjectSemana['fechaStart'] == $fechaXsemana['week_start'])
                      @if ($tXProjectSemana['total'] != 0)
                        @foreach ($allProjects as $projects)
                          @if ($tXProjectSemana['idPro'] == $projects->id)
                            <strong> *{{$projects->name_project}}: ${{number_format($tXProjectSemana['total'],2)}}</strong>
                            <br>
                          @endif
                        @endforeach
                      @endif
              ...
              <td style="border-color: black; vertical-align:middle" width="450"align="center">
                @foreach ($totales as $t)
                  @if($t['weekStart'] == $fechaXsemana['week_start'])
                    <div class="row-sm">
        ...
        <length class="text-center" id="titulosResponsive">Total Current Spent x Week</length>
        <length class="text-center" id="titulosResponsive">${{number_format($totalXQuery,2)}}</length>
        @if ($totalXQuery != 0)
        <div class="container-fluid-a" style="overflow-x:auto;">
          <table class="table table-striped" border="1">
            <tbody>
      ...
      <div class="container-fluid-a" style="overflow-x:auto;">
        <table class="table table-striped" border="1" >
          <tbody>
            @foreach ($arrayProfit as $pfitArray )
            <tr>
                <td style="border-color: black; " width="450">
                  <strong>{{$pfitArray['name']}}</strong>  
                  <br>
                  @if ($pfitArray['red'] != 0)
                ...
                <td style="border-color: black;" width="450">
                  <strong>Budget:</strong> <em>${{number_format($pfitArray['budget'],2)}}</em> 
                </td>
                <td style="border-color: black;"  width="450">
                  <strong>Sold:</strong> <em>${{number_format($pfitArray['sold'],2)}}</em> 
                </td>
                <td style="border-color: black;" width="450">
                  <strong>Expenses:</strong> <em>${{number_format($pfitArray['expenses'],2)}}</em> 
                </td>
                {{-- <td style="border-color: black;" width="450">
                  <strong>Current Expenses:</strong> <em>${{$pfitArray['totalExpenses']}}</em> 
                </td> --}}
                {{-- <td style="border-color: black;" width="450">
                  <strong>Profit:</strong> <em>${{$pfitArray['profit']}}</em> 
                </td> --}}
            </tr>
            @endforeach
            <tr>
              ...
              {{-- <td style="border-color: black;" width="450">
                <strong>${{$totalesProjects[0]['totalExpensesActualy']}}</strong> 
              </td> --}}
              {{-- <td style="border-color: black;" width="450">
