...
{{--         <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="card-projects">
                    <div class="card-body">
                      <h4 class="card-title"><span class="badge bg-secondary" style="color: white;">{{$nPPaused}}</span> Archived</h4>
                      <div id="accordion">
                        @foreach ( $projectsPaused as $pPaused )
                        <div class="card">
                          <div class="card-header" id="headingOne" style="padding: 0px;">
            ...
            <length class="text-center" id="titulosResponsive"><a href="{{route('payrollDays',[$sDate,$eDate,5])}}">Total Payroll</a> </length>
