  ...
  <div class="card text-center">
    <div class="card-header">
      <ul class="nav nav-tabs card-header-tabs" id="hideNav">
        ...
        <li class="nav-item">
            <a class="nav-link active" aria-current="true" href="#"><b>Last Month</b></a>
        </li>
        ...
        <table class="table table-striped" border="1" >
          <tbody>
            ...
            <tr>
                ...
                <td style="border-color: black;" width="450">
                  <strong>Expenses until {{$endDate}}:</strong> <em>${{number_format($pfitArray['expenses'],2)}}</em> 
                </td>
                <td style="border-color: black;" width="450">
                  <strong>Current Expenses:</strong> <em>${{number_format($pfitArray['totalExpenses'],2)}}</em> 
                </td>
                {{-- <td style="border-color: black;" width="450">
            ...
            <tr>
              ...
              <td style="border-color: black;" width="450">
                <strong>${{number_format($totalesProjects[0]['totalExpensesActualy'],2)}}</strong> 
              </td>
              {{-- <td style="border-color: black;" width="450">
